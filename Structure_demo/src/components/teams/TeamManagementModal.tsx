...
// Placeholder - teams not implemented in backend
const getTeamFileCount = (_teamId: string): number => 0;
        ...
        <div className="bg-gray-50 border-b border-gray-200 px-8 pt-6">
          <nav className="flex space-x-1">
            <button
              ...
              className={`flex items-center gap-2 px-5 py-3 rounded-t-xl font-medium text-sm transition-all duration-200 ${activeTab === "members"
            ...
            >
              ...
              Members
              <span
                className={`ml-1 px-2 py-0.5 text-xs font-semibold rounded-full ${activeTab === "members"
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-3 rounded-t-xl font-medium text-sm transition-all duration-200 ${activeTab === "files"
                  ? "bg-white text-primary-600 shadow-sm -mb-px"
                  : "text-gray-600 hover:text-gray-900 hover:bg-white/50"
                }`}
            >
              ...
              Files
              <span
                className={`ml-1 px-2 py-0.5 text-xs font-semibold rounded-full ${activeTab === "files"
                    ? "bg-primary-100 text-primary-700"
                    : "bg-gray-200 text-gray-600"
                  }`}
              >
            ...
            {isAdmin && (
              <button
                ...
                className={`flex items-center gap-2 px-5 py-3 rounded-t-xl font-medium text-sm transition-all duration-200 ${activeTab === "settings"
                    ? "bg-white text-primary-600 shadow-sm -mb-px"
                    : "text-gray-600 hover:text-gray-900 hover:bg-white/50"
                  }`}
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${team.settings.allowMemberInvites
                          ? "bg-primary-600"
                          : "bg-gray-200"
                        }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${team.settings.allowMemberInvites
                            ? "translate-x-6"
                            : "translate-x-1"
                          }`}
                      />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${team.settings.allowFileSharing
                          ? "bg-primary-600"
                          : "bg-gray-200"
                        }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${team.settings.allowFileSharing
                            ? "translate-x-6"
                            : "translate-x-1"
                          }`}
                      />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${team.settings.requireApproval
                          ? "bg-primary-600"
                          : "bg-gray-200"
                        }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${team.settings.requireApproval
                            ? "translate-x-6"
                            : "translate-x-1"
                          }`}
                      />
