  ...
  'team-1': [
    {
      ...
      joinedAt: new Date('2024-01-10').toISOString(),
      lastActive: new Date('2024-03-14T10:30:00').toISOString(),
    },
    {
      id: 'member-1-2',
      name: 'Jane Smith',
      ...
      lastActive: new Date('2024-03-13T15:20:00').toISOString(),
    },
    {
      id: 'member-1-3',
      name: 'Bob Wilson',
      ...
      joinedAt: new Date('2024-01-15').toISOString(),
      lastActive: new Date('2024-03-14T09:45:00').toISOString(),
    },
    {
      id: 'member-1-4',
      name: 'Alice Brown',
      ...
      lastActive: new Date('2024-03-12T14:10:00').toISOString(),
    },
    {
      id: 'member-1-5',
      name: 'Charlie Davis',
      ...
      joinedAt: new Date('2024-02-01').toISOString(),
      lastActive: new Date('2024-03-14T11:00:00').toISOString(),
    },
    {
      id: 'member-1-6',
      name: 'Diana Evans',
      ...
      joinedAt: new Date('2024-02-05').toISOString(),
      lastActive: new Date('2024-03-13T16:30:00').toISOString(),
    },
    {
      id: 'member-1-7',
      name: 'Ethan Foster',
      ...
      joinedAt: new Date('2024-02-10').toISOString(),
      lastActive: new Date('2024-03-11T10:15:00').toISOString(),
    },
    {
      id: 'member-1-8',
      name: 'Fiona Green',
      ...
      lastActive: new Date('2024-03-14T08:45:00').toISOString(),
    },
  ],
  'team-2': [
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=George',
      joinedAt: new Date('2024-01-15').toISOString(),
      lastActive: new Date('2024-03-14T09:00:00').toISOString(),
    },
    {
      id: 'member-2-2',
      name: 'Hannah Lee',
      ...
      joinedAt: new Date('2024-01-18').toISOString(),
      lastActive: new Date('2024-03-13T14:30:00').toISOString(),
    },
    {
      id: 'member-2-3',
      name: 'Ian Moore',
      ...
      joinedAt: new Date('2024-01-20').toISOString(),
      lastActive: new Date('2024-03-12T11:20:00').toISOString(),
    },
    {
      id: 'member-2-4',
      name: 'Julia Nelson',
      ...
      lastActive: new Date('2024-03-14T10:45:00').toISOString(),
    },
    {
      id: 'member-2-5',
      name: 'Kevin Park',
      ...
      joinedAt: new Date('2024-02-01').toISOString(),
      lastActive: new Date('2024-03-11T15:10:00').toISOString(),
    },
  ],
  'team-3': [
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Laura',
      joinedAt: new Date('2024-02-01').toISOString(),
      lastActive: new Date('2024-03-14T11:30:00').toISOString(),
    },
    {
      id: 'member-3-2',
      name: 'Mike Roberts',
      ...
      lastActive: new Date('2024-03-13T09:45:00').toISOString(),
    },
    {
      id: 'member-3-3',
      name: 'Nancy Scott',
      ...
      joinedAt: new Date('2024-02-05').toISOString(),
      lastActive: new Date('2024-03-12T16:20:00').toISOString(),
    },
    {
      id: 'member-3-4',
      name: 'Oscar Taylor',
      ...
      lastActive: new Date('2024-03-14T08:30:00').toISOString(),
    },
    {
      id: 'member-3-5',
      name: 'Paula White',
      ...
      joinedAt: new Date('2024-02-10').toISOString(),
      lastActive: new Date('2024-03-11T12:00:00').toISOString(),
    },
    {
      id: 'member-3-6',
      name: 'Quinn Adams',
      ...
      lastActive: new Date('2024-03-13T13:15:00').toISOString(),
    },
  ],
  'team-4': [
    {
      ...
      joinedAt: new Date('2024-02-10').toISOString(),
      lastActive: new Date('2024-03-14T10:00:00').toISOString(),
    },
    {
      id: 'member-4-2',
      name: 'Sam Carter',
      ...
      joinedAt: new Date('2024-02-12').toISOString(),
      lastActive: new Date('2024-03-13T11:30:00').toISOString(),
    },
    {
      id: 'member-4-3',
      name: 'Tom Davis',
      ...
      joinedAt: new Date('2024-02-15').toISOString(),
      lastActive: new Date('2024-03-12T14:45:00').toISOString(),
    },
    {
      id: 'member-4-4',
      name: 'Uma Foster',
      ...
      lastActive: new Date('2024-03-11T09:20:00').toISOString(),
    },
  ],
};
...
export const removeTeamMember = (teamId: string, memberId: string): void => {
  if (mockTeamMembers[teamId]) {
    mockTeamMembers[teamId] = mockTeamMembers[teamId].filter(m => m.id !== memberId);
...
export const updateTeamMemberRole = (teamId: string, memberId: string, newRole: 'admin' | 'member' | 'viewer'): void => {
  if (mockTeamMembers[teamId]) {
...
export const updateTeam = (teamId: string, updatedTeam: Team): Team | undefined => {
